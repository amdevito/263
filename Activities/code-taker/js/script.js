...
Code Taker Activity
Alana DeVito
Uncover secret letters in the poem by mousing over them. Once found they can drag the letters in the correct order to the answer area to find the sefcret code (name of the instrument, 'theremin'). Receive congratulations.
*/
